...
#' @examples
#'   testthat::expect_false(beastier:::is_jar_path("beast"))
#'   testthat::expect_true(beastier:::is_jar_path("beast.jar"))
#'   testthat::expect_false(beastier:::is_jar_path(get_default_beast2_bin_path()))
#'   testthat::expect_true(beastier:::is_jar_path(get_default_beast2_jar_path()))
#' @noRd
